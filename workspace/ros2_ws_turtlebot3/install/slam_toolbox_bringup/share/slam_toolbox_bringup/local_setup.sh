...
: ${AMENT_CURRENT_PREFIX:="/workspace/ros2_ws_turtlebot3/install/slam_toolbox_bringup"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/slam_toolbox_bringup/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/slam_toolbox_bringup/environment/path.sh"
